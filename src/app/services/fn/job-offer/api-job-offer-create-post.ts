...
export function apiJobOfferCreatePost(http: HttpClient, rootUrl: string, params?: ApiJobOfferCreatePost$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
