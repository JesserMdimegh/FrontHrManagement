...
export class ApplicationService extends BaseService {
   ...
   */
  apiApplicationApplyPost$Response(params?: ApiApplicationApplyPost$Params, context?: HttpContext): Observable<StrictHttpResponse<string>> {
    return apiApplicationApplyPost(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `apiApplicationApplyPost$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  apiApplicationApplyPost(params?: ApiApplicationApplyPost$Params, context?: HttpContext): Observable<string> {
   ...
   */
  apiApplicationOfferJobOfferIdCandidatesGet$Response(params: ApiApplicationOfferJobOfferIdCandidatesGet$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<CandidatDto>>> {
   ...
   * This method doesn't expect any request body.
   */
  apiApplicationOfferJobOfferIdCandidatesGet(params: ApiApplicationOfferJobOfferIdCandidatesGet$Params, context?: HttpContext): Observable<Array<CandidatDto>> {
